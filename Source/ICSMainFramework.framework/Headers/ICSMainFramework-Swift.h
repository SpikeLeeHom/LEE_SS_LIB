...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ICSMainFramework",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC16ICSMainFramework11AppDelegate")
...
SWIFT_PROTOCOL("_TtP16ICSMainFramework20AppLifeCycleProtocol_")
@protocol AppLifeCycleProtocol <UIApplicationDelegate>
@end
